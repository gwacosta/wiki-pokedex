...
export default function Detalhes() {
    ...
    return (
        ...
        <section className="flex flex-col mt-32 mx-auto items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-5xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
