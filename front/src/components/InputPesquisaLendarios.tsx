...
export function InputPesquisaLendarios({ setPokemons }: InputPesquisaProps) {
    ...
    async function enviaPesquisa(data: Inputs) {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/pokemons/pesquisaLendarios/${data.termo}`)
